...
var style_default = genComponentStyleHook("Table", (token) => {
  const {
    controlItemBgActive,
  ...
  return [genTableStyle(tableToken), pagination_default(tableToken), summary_default(tableToken), sorter_default(tableToken), filter_default(tableToken), bordered_default(tableToken), radius_default(tableToken), expand_default(tableToken), summary_default(tableToken), empty_default(tableToken), selection_default(tableToken), fixed_default(tableToken), sticky_default(tableToken), ellipsis_default(tableToken), size_default(tableToken), resize_default(tableToken), rtl_default(tableToken)];
});

export {
  style_default
};
//# sourceMappingURL=chunk-WKP2A575.js.map
